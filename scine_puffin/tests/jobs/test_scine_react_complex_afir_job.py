...
class ScineReactComplexAfirJobTest(JobTestCase):
    ...
    def test_energy_and_structure(self):
        # import Job
        from scine_puffin.jobs.scine_react_complex_afir import ScineReactComplexAfir
        ...
        job = db.Job('scine_react_complex_afir')
        settings = {
        ...
        self.assertAlmostEqual(energy.get_data(), -31.65957185657797, delta=1e-1)
